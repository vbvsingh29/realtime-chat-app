...
*   **User Authentication:** Secure register/login flow using `bcrypt` password hashing and `jsonwebtoken` session tokens. Only logged-in users can participate in chat rooms.
